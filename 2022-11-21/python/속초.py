...
url = 'https://www.google.com/travel/things-to-do/see-all?dest_mid=%2Fm%2F02v5tv&dest_state_type=sattd&dest_src=yts&q=%EC%86%8D%EC%B4%88&ved=0CAAQ8IAIahcKEwj4lYjagMT7AhUAAAAAHQAAAAAQCQ'
...
with open('./json/sc.json','w',encoding='utf-8') as f:
