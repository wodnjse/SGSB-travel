...
url = 'https://www.google.com/travel/things-to-do/see-all?dest_mid=%2Fm%2F0hv7l&dest_state_type=sattd&dest_src=yts&q=%EB%B6%80%EC%82%B0&ved=0CAAQ8IAIahcKEwiAm-rFgsT7AhUAAAAAHQAAAAAQHA'
...
for i in range(1,99):
  ...
  datas.append(data)
datas = sorted(datas,key = itemgetter('별점','명소'),reverse=True)
with open('./json/busan.json','w',encoding='utf-8') as f:
