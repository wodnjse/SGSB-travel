...
function on_pop_seoul(){
    jQuery(document).ready(function(){
    $('#seoulModal').show();
    });
}
function close_pop_seoul(flag){
    $('#seoulModal').hide();
}

function on_pop_gyeonggi(){
    jQuery(document).ready(function(){
    $('#gyeonggiModal').show();
    });
}
function close_pop_gyeonggi(flag){
    $('#gyeonggiModal').hide();
}

function on_pop_sokcho(){
    jQuery(document).ready(function(){
    $('#sokchoModal').show();
    });
}
function close_pop_sokcho(flag){
    $('#sokchoModal').hide();
}

function on_pop_busan(){
    jQuery(document).ready(function(){
    $('#busanModal').show();
    });
}
function close_pop_busan(flag){
    $('#busanModal').hide();
}