...
url = 'https://www.google.com/travel/things-to-do/see-all?dest_mid=%2Fm%2F0hsqf&dest_state_type=sattd&dest_src=yts&q='+'서울'+'&ved=0CAAQ8IAIahcKEwigjOjZg7_7AhUAAAAAHQAAAAAQCw'
...
with open('./json/seoul.json','w',encoding='utf-8') as f:
